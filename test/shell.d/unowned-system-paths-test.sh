...
allowed = {
  ...
  # Written through a variable, so the scan below cannot see it at the point it
...
skip_scripts = {"bin/omarchy-upgrade-to-quattro", "install/config/system-files.sh", "install/helpers/fedora-first-party.sh"}
